...
from core.prompting.history import PromptHistory, PromptHistoryReplacer


@pytest.fixture()
def replacer(history: PromptHistory) -> PromptHistoryReplacer:
    return PromptHistoryReplacer(history)
